...
<td><a onclick="window.open('/admin/user/view?user_no=${list.user_no }','window_name','width=430,height=500,location=no,status=no,scrollbars=yes');" style="color:blue;">조회</a></td>
<td id="delete"><a href="/admin/user/delete?user_no=${list.user_no }" style="color:red;">삭제</a></td>
...
<div class='text-center' style="clear:both;">
  <FORM name='search' method='post' action='/admin/user/search'>
